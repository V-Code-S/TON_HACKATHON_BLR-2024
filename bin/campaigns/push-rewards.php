...
$entities = new MeTon\Core\Data\Call('entities');
$indexes = new MeTon\Core\Data\Call('entities_by_time');
$lu = new MeTon\Core\Data\Call('user_index_to_guid');
...
while(true){
    ...
    foreach($users as $guid => $data){
        ...
        $msg = "Use MeTon today to get 10 free points!";
